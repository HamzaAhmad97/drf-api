...
class TestPostModel(TestCase):
    ...
    def test_blog_content(self):
        ...
        self.assertEqual(post.content, 'Words about the blog')

class TestAPI(APITestCase):
    def test_list(self):
        response = self.client.get(reverse('api_main'))
    ...
    def test_detail(self):
        ...
        response = self.client.get(reverse('post_details', args=[1]), format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_create(self):
        ...
        data = {
            ...
            "content":"when the right tools are available",
            "author":test_user.id,
    ...
    def test_update(self):
        ...
        url = reverse('post_details',args=[test_post.id])
        data = {
            "title":"Testing is Still Fun!!!",
            "author":test_user.id,
            "content":test_post.content,
            "notes" : test_post.notes
        }
